...
import { applyTaskWorkspaceOutcome, classifyTaskWorkspaceOutcome, } from '../src/services/task-workspace-lifecycle.js';
function task(state, overrides = {}) {
    return {
...
test('ownership mismatch fails closed before cleanup or hold mutation', async () => {
    await assert.rejects(applyTaskWorkspaceOutcome({
        task: task('PASSED'),
        recordRoot: '/records',
...
//# sourceMappingURL=task-workspace-lifecycle.test.js.map