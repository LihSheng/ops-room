...
import { createOrClaimTask, readTask, requestCancellation, transitionTask } from '../src/services/review-task-store.js';
import { assertReviewNotCancelled } from '../src/workflows/review-worker-guard.js';
test('cancellation during slow execution is cooperatively detected', async () => {
    ...
    assert.throws(() => assertReviewNotCancelled(cancelled), { code: 'REVIEW_CANCELLED' });
});
...
//# sourceMappingURL=cancellation-during-execution.test.js.map