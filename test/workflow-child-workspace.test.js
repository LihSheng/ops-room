...
import { ensureWorkflowChildWorkspace, selectWorkflowChildWorkspacePlan, } from '../src/services/workflow-child-workspace.js';
...
test('workspace ownership, branch, and SHA mismatches fail closed', async () => {
    ...
    try {
        ...
        for (const [overrides, expected] of [
            ...
            await assert.rejects(ensureWorkflowChildWorkspace({
                workflowRunsDir: value.workflowRunsDir,
                workflowId: value.workflowId,
                childId: child.child_id,
                ...roots(value.root),
...
//# sourceMappingURL=workflow-child-workspace.test.js.map