...
test('CLAIMED effect cannot be double-resolved', async () => {
    ...
    await assert.rejects(() => resolveAmbiguousEffect({ dir, effectId: claimed.effect.id, resolution: 'abandon' }), /Can only resolve CLAIMED/);
});
...
//# sourceMappingURL=effect-reconciliation.test.js.map