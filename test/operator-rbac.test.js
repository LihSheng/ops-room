...
import { hasOperatorPermission, normalizeOperatorRoles, permissionsForOperatorRoles, requireOperatorPermission, } from '../src/services/operator-rbac.js';
...
test('unknown permissions and denied actions fail closed', () => {
    ...
    assert.throws(() => requireOperatorPermission(['viewer'], 'task.manage'), /operator_permission_denied:task.manage/);
    assert.throws(() => requireOperatorPermission(['viewer'], 'mission.create'), /operator_permission_denied:mission.create/);
...
//# sourceMappingURL=operator-rbac.test.js.map