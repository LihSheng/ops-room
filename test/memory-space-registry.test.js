...
import { MemorySpaceValidationError, validateMemorySpaceManifest, } from '../src/services/memory-space-registry/schema.js';
...
test('manifest schema rejects unsafe roots, traversal, wildcard, ownership, write policy, provenance, and secret fields', () => {
    ...
    for (const [value, pattern] of cases) {
        assert.throws(() => validateMemorySpaceManifest(value, 'fixture/manifest.json'), pattern);
    }
});
...
//# sourceMappingURL=memory-space-registry.test.js.map