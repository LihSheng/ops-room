...
export function toPublicProfileSkillAssignments(profile, assignments) {
...
export function toPublicSkillCatalogItem(manifest, assignments) {
...
export function buildPublicSkillCatalog(manifests, assignments) {
    return manifests
        .slice()
...
export function toPublicSkillDetail(manifest, assignments) {
...
//# sourceMappingURL=public-skill.js.map