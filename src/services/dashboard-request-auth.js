...
import { AUDIT_DIR, HUMAN_AUTH_ENABLED, OPERATOR_SESSION_DIR, } from './runtime-paths.js';
...
export async function authorizeDashboardReadRequest({ req, humanAuthEnabled = HUMAN_AUTH_ENABLED, sessionDir = OPERATOR_SESSION_DIR, auditDir = AUDIT_DIR, verifyDashboardBearer = verifyDashboardAuth, readSession = readOperatorSession, appendAudit = appendAuditEvent, now, }) {
...
//# sourceMappingURL=dashboard-request-auth.js.map