import { OPERATOR_DISPLAY_NAME, OPERATOR_ID, } from './runtime-paths.js';
const SAFE_ACTOR_ID = /^[A-Za-z0-9._:-]{2,100}$/;
export function resolveOperatorIdentity({ actorId = OPERATOR_ID, displayName = OPERATOR_DISPLAY_NAME, authMethod = 'operator_token', } = {}) {
