...
export function buildPrReviewPayload({ commentBody, repository, prNumber, commenter, commentId, headSha, }) {
...
export function buildPrReviewPrompt({ agent, task, repository, pr, prTitle, prBody, prAuthor, baseRef, headRef, headSha, mode = 'review', diff, }) {
...
//# sourceMappingURL=pr-review-payload.js.map