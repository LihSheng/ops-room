 ...
 * src/workflows/fix-runtime.mjs, which is the only module that needs it.
 *
...
export async function runAutoFixWorkflow(_params) {
  throw new Error(
    'Legacy auto-fix workflow has been retired. ' +
...
/**
 * @deprecated Use {parseFiles} from fix-runtime.mjs instead.
 */
